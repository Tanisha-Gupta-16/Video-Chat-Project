...
export const getLocalPreviewInitRoomConnection = async (
  ...
  navigator.mediaDevices
    ...
    .catch((err) => {
      console.log("error occured to get local stream");
      console.log(err);
    });
};
...
const addStream = (stream, connUserSocketId) => {
  ...
  if (participant?.onlyAudio) {
    ...
    videosContainer.style.position = "static";
  }
  videosContainer.appendChild(videoContainer);
};
const getAudioOnlyLabel = (identity = "") => {
  ...
  label.classList.add("label_only_audio_container");
